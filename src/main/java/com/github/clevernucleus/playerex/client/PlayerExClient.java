...
public class PlayerExClient implements ClientModInitializer {
	...
	public static final Identifier DEFAULT = new Identifier(ExAPI.MODID, "textures/gui/skills.png");

	public static final Identifier BUTTONS = new Identifier(ExAPI.MODID, "textures/gui/skills.png");
